...
$(document).ready(function(){
    ...
    dragula([document.getElementById('basic-accordion1')]);
    dragula([document.getElementById('basic-accordion2')]);
    dragula([document.getElementById('basic-accordion3')]);
    dragula([document.getElementById('basic-accordion4')]);

    // accordion icons
    dragula([document.getElementById('accordion-icon-drag')]);
    dragula([document.getElementById('accordion-icon-1')]);
    dragula([document.getElementById('accordion-icon-2')]);
    dragula([document.getElementById('accordion-icon-3')]);
    dragula([document.getElementById('accordion-icon-4')]);

    // Basic Collapse
    dragula([document.getElementById('headingCollapse1')]);
    dragula([document.getElementById('collapse-drag-1')]);
    dragula([document.getElementById('collapse-drag-2')]);
    dragula([document.getElementById('collapse-drag-3')]);
    dragula([document.getElementById('collapse-drag-4')]);

    // Collapsible with Border
    dragula([document.getElementById('headingCollapse51')]);
    dragula([document.getElementById('collapse-drag-border-1')]);
    dragula([document.getElementById('collapse-drag-border-2')]);
    dragula([document.getElementById('collapse-drag-border-3')]);
    dragula([document.getElementById('collapse-drag-border-4')]);
