...
$(function () {
    ...
    List.prototype = {
        ...
        _createFooter: function () {
            ...
            $('<button>', {
                type: 'button',
                'class': 'btn btn-link btn-show-form',
                'html': 'Add new'
            }).click(function () {
                me._resetForm();
        ...
        _createFinishTitleEditing: function () {
            ...
            var $btn = $('<button>', {
                ...
                html: '<i class="ft ft-check-circle"></i>'
            });
            $btn.click(function () {
