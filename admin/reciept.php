                                ...
                                <div class="card-content collapse show div2" id="printMe">
                                    <div class="card-body card-dashboard dataTables_wrapper dt-bootstrap">                                        
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h4 class="pull-right m-r-10 font-bold">Invoice Number <br><small class="font-bold">#3200</small></h4>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <?php if (!empty($_SESSION['customer'])) {
                                                    ...
                                                    foreach ($res as $ress) {
                                                    ?>
                                                <h5 class="text-italic">Name: <small><?=$ress['fullName']?></small></h5>
                                                <h5 class="text-italic">Contact: <small><?=$ress['phoneNo']?></small></h5>
                                                <h5 class="text-italic">Address: <small><?=$ress['address']?></small></h5>
                                                <?php 
                                                    }
                                                }  ?>
                                                </div>
