            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="email" name="email" class="form-control mb-1" required data-validation-required-message="Email required" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="password" name="password" class="form-control mb-1" required data-validation-required-message="Password required" required>
                        </div>
                    </div>
                </div>
